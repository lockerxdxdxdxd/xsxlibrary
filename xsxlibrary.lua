...
local library = {
    version = "2.0.0",
    title = title or "ccxz " .. tostring(math.random(1,366)),
    fps = 0,
    rank = "private"
}
...
function library:Introduction()
    ...
    local barCorner = Instance.new("UICorner")
    local barLayout = Instance.new("UIListLayout")
    local ccxzLogo = Instance.new("ImageLabel")
    local hashLogo = Instance.new("ImageLabel")
    local ccxz = Instance.new("TextLabel")
    ...
    ccxzLogo.Name = "ccxzLogo"
    ccxzLogo.Parent = background
    ccxzLogo.AnchorPoint = Vector2.new(0.5, 0.5)
    ccxzLogo.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    ccxzLogo.BackgroundTransparency = 1.000
    ccxzLogo.Position = UDim2.new(0.5, 0, 0.5, 0)
    ccxzLogo.Size = UDim2.new(0, 448, 0, 150)
    ccxzLogo.Visible = true
    ccxzLogo.Image = "http://www.roblox.com/asset/?id=9365068051"
    ccxzLogo.ImageColor3 = Color3.fromRGB(159, 115, 255)
    ccxzLogo.ImageTransparency = 1
    ...
    ccxz.Name = "ccxz"
    ccxz.Parent = background
    ccxz.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    ...
    CreateTween("ccxzRotation", 0)
    local MinusAmount = -16
    coroutine.wrap(function()
        while wait() do
            MinusAmount = MinusAmount + 0.4
            TweenService:Create(ccxzLogo, TweenTable["ccxzRotation"], {Rotation = ccxzLogo.Rotation - MinusAmount}):Play()
        end
    end)()
    ...
    wait(.2)
    TweenService:Create(ccxz, TweenTable["introduction"], {TextTransparency = 0}):Play()
    TweenService:Create(text, TweenTable["introduction"], {TextTransparency = 0}):Play()
    wait(.3)
    TweenService:Create(ccxzLogo, TweenTable["introduction"], {ImageTransparency = 0}):Play()
    wait(2)
    TweenService:Create(ccxzLogo, TweenTable["introduction"], {ImageTransparency = 1}):Play()
    wait(.2)
    ...
    wait(.1)
    TweenService:Create(ccxz, TweenTable["introduction"], {TextTransparency = 1}):Play()
    wait(.1)
